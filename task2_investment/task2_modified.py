...
prompt_decision_guidelines = (
    ...
    "Process:\n"
    "1. Label each statement as POSITIVE (favorable news, e.g., growth, profits, strong performance) or NEGATIVE (unfavorable news, e.g., costs, losses, difficulties)\n"
    "2. Calculate proportion for each company: positive_count / (positive_count + negative_count)\n"
    "3. Choose the company with the HIGHER proportion\n\n"
    "Example: Company A (4 positive, 1 negative = 80%) equals Company B (16 positive, 4 negative = 80%). "
